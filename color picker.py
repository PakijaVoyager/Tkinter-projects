...
def findcolor():
    ...
    color.itemconfig(id6,fill=color6)
    color.itemconfig(id7,fill=color7)
    color.itemconfig(id8,fill=color8)
    color.itemconfig(id9,fill=color9)
    color.itemconfig(id10,fill=color10)
...
# img_2 = Image.open("stegano.jpeg")
# img_2 = ImageTk.PhotoImage(img_2)
# Label(frame,image=img_2,bg="#fff").place(x = 10, y = 10)

Label(frame,text="Color finder",font="Robote 25 bold",bg="white").place(x = 100, y = 20)

# Color1
color = Canvas(frame,bg="#fff",width=150,height=265)
...
hex1 = Label(color,text="#b8255f",fg="#000",font="arial 12 bold",bg="white")
...
f = Frame(selectimage,bg="black",width=320,height=280,relief=GROOVE)
f.place(x = 10, y = 10)

lbl = Label(f,bg="black")
lbl.place(x = 0, y = 0)

Button(selectimage,text="Select Image",width=12,height=1,font="arial 12 bold",command=showimage).place(x = 10, y = 300)
Button(selectimage,text="Find color",width=12,height=1,font="arial 12 bold",command=findcolor).place(x = 200, y = 300)
